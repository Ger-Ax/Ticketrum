...
@section('pageTitle', isset($pageTitle) ? $pageTitle: 'Tu perfil de administrador')
@section('content')
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
            <div class="pd-20 card-box height-100-p">
                <div class="profile-photo">
                    <a href="modal"  class="edit-avatar"> <i class="fa fa-pencil"></i>
                    </a>
                    <img src="{{$admin -> picture}}" alt=" "class="avatar-photo" id="AdminProfilePicture">

                    
                </div>
                <h5 class="text-center h5 mb-0" id="adminProfileName"> {{$admin->nombre}} </h5>
